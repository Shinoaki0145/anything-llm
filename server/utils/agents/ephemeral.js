...
class EphemeralAgentHandler extends AgentHandler {
   ...
   * or when the workspace is in automatic mode.
   * @param {{message: string, chatMode?: string}} parameters
   * @returns {Promise<boolean>}
   */
  static async isAgentInvocation({ message, chatMode = null }) {
    if (this.#isAgentCommandInvocation({ message })) return true;
    return chatMode === "automatic";
  }
